...
if (isset($_GET['npm'])) {
    ...
    header("location:viewmahasiswa.php"); exit;
}
?>
<!DOCTYPE html>
<html lang="id">
        ...
        <div class="form-grid">
          ...
          <div class="form-group">
            ...
            <select name="prodi" id="prodi" class="form-control" required>
              <?php
                $prodiList = ['Teknik Informatika','Sistem Informasi','Teknologi Informasi','Teknik Sipil'];
          ...
          <div class="form-actions">
            <button type="submit" name="edit" class="btn btn-success btn-lg">
              💾 Update Data
            </button>
