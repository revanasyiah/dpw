...
<title>Tambah Mahasiswa – Akademik OOP</title>
...
<div class="page" style="max-width:600px">
  ...
  <div class="page-header">
    <div>
      ...
      <div class="page-subtitle">Isi formulir untuk menambahkan data mahasiswa baru</div>
    </div>
  </div>
      ...
      <form action="proses_inputmahasiswa.php" method="POST">
        <div class="form-grid">
          ...
          <div class="form-group">
            ...
            <span class="form-hint">NPM bersifat unik dan tidak dapat diubah</span>
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" name="alamat" id="alamat"
                   class="form-control" required
                   placeholder="Contoh: Jl. Mawar No. 5, Madiun">
          </div>
